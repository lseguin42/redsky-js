...
(function (module_export) {
    ...
    PDSApplication.prototype._listAuthorizedLog = function () {
        var self  = this;
     ...
     * Active debug mode
     */
    PDSApplication.prototype.debug = function (level) {
        var self = this;
        ...
        console.log('[DEBUG]: pds debug display [', s, ']');
    }
    
    /**
     * Log value autorized of global __PDS_DEGUG_LEVEL__
     * 
     ...
     * -3  => display [error]
     */
    PDSApplication.prototype._console = function (type) {
        var self = this;
    ...
    Object.defineProperty(PDSApplication.prototype, 'log', {
        get: function () {
            return this._console('log');
        }
    });
    
    Object.defineProperty(PDSApplication.prototype, 'warn', {
        get: function () {
            return this._console('warn');
        }
    });
    
    Object.defineProperty(PDSApplication.prototype, 'error', {
        get: function () {
